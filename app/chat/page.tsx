    ...
    <div className="flex flex-col h-screen max-w-3xl mx-auto">
      ...
      <div className="flex items-center gap-3 px-6 py-4 border-b border-gray-800">
        ...
        <div>
          ...
          <p className="text-xs text-gray-500">Master Team Console · Proof of Concept</p>
        </div>
        ...
        {messages.map((msg, i) => (
          <div key={i} className={`flex ${msg.role === "user" ? "justify-end" : "justify-start"}`}>
            {msg.role === "user" ? (
              ...
              <div className="w-full max-w-xl">
                <ResultCard
                  expertResults={msg.expertResults}
      ...
      <div className="px-6 py-4 border-t border-gray-800">
        <form onSubmit={handleSubmit} className="flex gap-3">
          <input
            ...
            placeholder={
              phase === "awaiting_approval"
                ? "Godkend planen ovenfor, eller skriv en ny brief…"
          ...
          <button
            ...
            className="rounded-xl bg-indigo-600 px-5 py-3 font-medium text-white hover:bg-indigo-500 disabled:opacity-50 transition-colors"
          >
            →
          </button>
        </form>
